...
export default () => ({
	...
	parser: {
		...
		selectors: {
			...
			feed: '.feed-note-wrapper',
			feedDate: '.feed-note__date',
			feedIdAttr: 'data-id',
			feedFileIdAttr: 'data-file-id',
			feedExpandBtn: '.js-grouped-expand',
			feedsContainer: '.notes-wrapper__notes.js-notes',
			messageExpandBtn: '.js-show-more.feed-note__show-more',
			messageText: '.feed-note__message_paragraph',
			messageText2: '.feed-note__field-changed-wrapper',
			messageText3: '.feed-note__header-inner-wrap',
		},
	},
})
